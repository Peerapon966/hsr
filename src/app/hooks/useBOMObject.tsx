...
export type UseBOMObjectProps =
  | WindowObjectProps
  | LocationObjectProps
  | AddEventListenerProps;

export function useBOMObject<T extends any[]>(props: UseBOMObjectProps[]): T {
        ...
        switch (prop.property) {
          ...
          case "addEventListener":
            return window.addEventListener(
              prop.args.event as keyof WindowEventMap,
              prop.args.callback as EventListenerOrEventListenerObject
            );
          default:
            break;
        }
